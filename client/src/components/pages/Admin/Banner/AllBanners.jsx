    ...
    <div className="relative bg-white p-4 rounded ">
      <div className="w-full">
        ...
        <h1 className="max-w-40 text-wrap line line-clamp-2">
          Banner for {data.ProductName}
        </h1>

        <div
          className="absolute bottom-2 right-2 w-fit ml-auto p-2 bg-slate-300 hover:bg-red-600 rounded-full hover:text-white cursor-pointer"
