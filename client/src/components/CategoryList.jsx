                    ...
                    categoryProduct.map((product,index)=>{
                        return(
                            <Link to={"/product-category/"+product?.category} key={product.category} className=' flex flex-col items-center justify-center cursor-pointer'>
                                <div className='w-16 h-16 md:w-20 md:h-20 rounded-full overflow-hidden p-2  border-2 border-accent-light shadow-pink-950 shadow-lg bg-white hover:bg-white flex items-center justify-center'>
